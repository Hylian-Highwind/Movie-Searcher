    ...
    if(isset ($_POST['reviewSubmit']) ){
        ...
        if(isset($_SESSION['logged_in'])){            
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                $reviewedAlready = "<h2>Found a review by you already!</h2>";
            }
            else{
...
<div class="Wrapper">
    ...
    <div class ="Review-Section">
        <button class="RedirectButton" onClick="location.href='index.php'" value='Home'>Home</button>

        
        <div class="Wrapper">
            <div id="reviewSubmissionDiv">
            
            <!--Display Duplicate review message if username already has one-->
            <?php if(isset($reviewedAlready)){
                    echo $reviewedAlready;
                }
            ...
            id = "reviewForm" Method = "POST">
                ...
                <?php 
                if(isset($_SESSION['logged_in'])){
                    echo "<button type='submit' class = 'RedirectButton' name ='reviewSubmit'> Post Review! </button>";
                }
                else{
                    echo "<button type = 'button' class = 'RedirectButton' onClick=location.href='login.php' value='Login'>Must Login to Review!</button>";
                }
        ...
        <!--Table for outputting the info from reviews-->
